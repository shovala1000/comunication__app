  ...
  return (
    <div className="new-contact-btn">
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <input type="text" className="form-control" id="modal-textbox"  placeholder="Enter contact username..." onKeyDown={handlePressedKey}></input>
            </div>
            <div className="modal-footer">
              <button type="button" className="btn btn-secondary" onClick={hideModal}>Close</button>
              <button type="button" className="btn btn-primary" onClick={() => checkInput(document.getElementById('modal-textbox').value)}>Add</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={classAlert} role="alert">{currentError}
        <button type="button" className="btn-close" aria-label="Close" onClick={() => setAlertActive(false)} ></button>
      </div>
    </div>
  );
}
